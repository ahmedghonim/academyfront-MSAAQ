...
import { PriceFilter, ProductFilters, ProductTypesFilter, RatingFilter, TaxonomiesFilter } from "@/components/filters";
import { ProductsSectionCard } from "@/components/product";
...
const ProductsListing = ({ initialProducts, initialFilters }: Props) => {
      ...
      {(handleParams, handleCheckboxInput) => (
        <>
          ...
          <ProductTypesFilter
            ...
            checked={(value) => handleCheckboxInput("type", value)}
          />
          <TaxonomiesFilter
            onChange={(checked, value, key) => handleParams(checked, value, key)}
